...
public class CustomerIntegrationTest {
    ...
    void canRegisterACustomer() {
        ...
        //get all customers
        final List<CustomerDTO> allCustomers = webTestClient.get()
                .uri(CUSTOMER_URI)
                .accept(MediaType.APPLICATION_JSON)
        ...
        CustomerDTO expectedCustomer = new CustomerDTO(id,
                name,
                email,
                gender,
                age,
    ...
    void canDeleteCustomer() {
        ...
        final String jwtToken = webTestClient.post()
                .uri(CUSTOMER_URI)
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void canUpdateCustomer() {
        ...
        //get customer by id
        final CustomerDTO updatedCustomer = webTestClient.get()
                .uri(CUSTOMER_URI + "/{id}", id)
                .accept(MediaType.APPLICATION_JSON)
                .header(AUTHORIZATION, String.format("Bearer %s", jwtToken))
                .exchange()
        ...
        CustomerDTO expected = new CustomerDTO(
                id, newName, email, gender, age, List.of("ROLE_USER"),
                email, null );
    ...
    void canUploadAndDownloadProfilePicture() throws IOException {
        ...
        CustomerDTO customerDTO = Objects.requireNonNull(allCustomers).stream()
                .filter(customer -> customer.email().equals(email))
                .findFirst()
                .orElseThrow();
        ...
        //get customer by id
        final String profileImageId = webTestClient.get()
